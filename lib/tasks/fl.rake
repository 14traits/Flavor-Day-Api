namespace :fl do
  ...
  task load_data: :environment do
    url = URI("https://hosted.where2getit.com/culvers/rest/locatorsearch?like=0.2143148989041409&lang=en_EN")
