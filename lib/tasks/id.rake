namespace :id do
  ...
  task load_data: :environment do
    url = URI("https://hosted.where2getit.com/culvers/rest/locatorsearch?like=0.6253441512389643&lang=en_EN")
    ...
    request.body = "{\"request\":{\"appkey\":\"1099682E-D719-11E6-A0C4-347BDEB8F1E5\",\"formdata\":{\"geoip\":false,\"dataview\":\"store_default\",\"geolocs\":{\"geoloc\":[{\"addressline\":\"Idaho\",\"country\":\"\",\"latitude\":\"\",\"longitude\":\"\"}]},\"searchradius\":\"25|50|100\",\"stateonly\":1,\"where\":{\"comingsoondate\":{\"eq\":\"null\"},\"or\":{\"number\":{\"eq\":\"\"},\"onlineorderstatus\":{\"eq\":\"\"}}},\"false\":\"0\"}}}"
