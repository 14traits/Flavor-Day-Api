namespace :sc do
  ...
  task load_data: :environment do
    url = URI("https://hosted.where2getit.com/culvers/rest/locatorsearch?like=0.26924738835151785&lang=en_EN")
